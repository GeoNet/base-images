...
> pipelines to sync, build and scan containers that are maintained, vendored and built for GeoNet
...
```shell
cosign verify \
  --certificate-identity-regexp 'https://github.com/GeoNet/docker-foundry/.github/workflows/(sync|build).yml@refs/heads/.*' \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  IMAGE_REF
```

please note: the _certificate identity_ field will vary between
- https://github.com/GeoNet/docker-foundry/.github/workflows/sync.yml@refs/heads/main
- https://github.com/GeoNet/docker-foundry/.github/workflows/build.yml@refs/heads/main
...
```shell
cosign verify-attestation IMAGE_REF --certificate-identity-regexp 'https://github.com/GeoNet/docker-foundry/.github/workflows/(sync|build.yml@refs/heads/.*' \
...
Verification for ghcr.io/GeoNet/docker-foundry/hello:latest --
...
|___/ .__/ \__,_/_/\_\
 ...
 📂 SPDX Document sbom-sha256:e1097a462313187e2a61ba229179efafa8e62bd6166dc94698c9dcffdff05c9c
  ...
  │  │  │ 
  │  │ 
  │  └ GENERATED_FROM PACKAGE github.com/GeoNet/docker-foundry@6d8476f50ccdd7864eb0d46b2036f44516a55336
  │ 
  └ 📄 DESCRIBES 0 Files
```
